...
public class iPPSwerveControllerCommand extends CommandBase {
    ...
    public iPPSwerveControllerCommand(
    ...
    public void execute() {
        ...
        Logger.getInstance().recordOutput("Swerve/Target Odometry", new double[] {
